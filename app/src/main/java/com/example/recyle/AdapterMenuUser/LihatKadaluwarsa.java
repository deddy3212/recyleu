...
public class LihatKadaluwarsa extends ArrayAdapter<ModelPesananTiket> {
    ...
    public LihatKadaluwarsa(Activity context, List<ModelPesananTiket> modelPesananTiketList) {
