...
public class AdminActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewAdmin.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                PilihiUpdateDelete(obt.getIdAdmin(), obt.getPassword(), obt.getName(),
        ...
        listViewAdmin.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bun.putString("idadmin",obt.getIdAdmin());
                //bun.putString("password",obt.getPassword());
                bun.putString("nama",obt.getName())
                ; bun.putString("email",obt.getEmail());
    ...
    protected void onStart() {
        super.onStart();
        final String t = FirebaseAuth.getInstance().getCurrentUser().getEmail();
    ...
    public void PilihiUpdateDelete(final String idadmin, String password, final String nama,
                                   String email, String telp  ) {
        androidx.appcompat.app.AlertDialog.Builder dialogBuilder = new
        ...
        editTextNIM.setText(idadmin); editTextPassword.setText(password);
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(idadmin)) {
                    UbahAdmin(ni, pas, na, em, te);
                    b.dismiss();
                }
            }
        });
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        final DatabaseReference dR = FirebaseDatabase.getInstance().
                                getReference("Administrator").child(idadmin);
